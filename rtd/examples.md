...
| `examples/ims/ims_ehss_offline_basic.json` | EHSS with a precomputed single gas offline sample file. |
| `examples/ims/ims_ipm_basic.json` | `InteractionPotentialModel` setup using an offline IPM sample file generated by `interaction_potential_precompute`. |
