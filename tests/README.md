...
- **Physics – Forces:** `test_electric_field_force.cpp`, `test_field_model_parity.cpp`, `test_field_model_provider.cpp`, `test_magnetic_damping_forces.cpp`, `test_force_registry.cpp`, `test_space_charge_force.cpp`, AoS↔SoA parity for direct SC (`test_space_charge_soa_parity.cpp`)
