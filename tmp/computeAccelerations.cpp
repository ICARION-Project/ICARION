...
#include "fields/defineSpaceChargeField.h"
#include "core/fields/fieldSampling.h"  // Core field sampling utilities

// Field server: Core-only uses shim, full build uses fieldsolver
#ifdef ICARION_BUILD_CORE_ONLY
    #include "core/fields/field_update_shim.h"
#else
    #include "fieldsolver/field_update_api.h"
#endif

#include "../../include/physics/fields_shared.h"
#include "../../include/physics/math_shared.h"
